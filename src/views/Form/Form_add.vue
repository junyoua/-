  ...
  <div id="form_add">
    <el-form :model="ruleForm" :rules="rules" label-width="80px" class="demo-ruleForm">
      ...
      <el-form-item class="bottom">
        <el-button type="primary" ref="fabu"  @click="submitForm('ruleForm')">立即发布</el-button>
...
export default {
  ...
  methods: {
    ...
    submitForm() {
      ...
      if (state) {
        //发送请求
        this.$refs.fabu.disabled=true;
        if (this.ruleForm.desc.trim()) {
          axios({
            url: 'https://hzti.xyz/PHP/content_insert.php',
            method: "post",
            params: {
              name: name,
              label:label,
